...
gulp.task('scripts', function() {
  ...
  var jsPaths = [
    ...
    bowerPath + '/bootstrap/dist/bootstrap.min.js',
    '_js/**/*.js'
  ];
...
gulp.task('watch', function() {
  ...
  gulp.watch(['index.html', '_includes/*.html', '_layouts/*.html', '_posts/*', 'about/*.html', 'contribute/*.html', 'images/*', 'contact/*'], ['jekyll-rebuild']);
});
